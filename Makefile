...
CFLAGS     += -Wall -D_FORTIFY_SOURCE=2 -g -Wno-pointer-sign \
	      ...
	      -DBIN_PATH=\"$(BIN_PATH)\" -I/home/fuzz/anaconda3/include/

ifneq "$(filter Linux GNU%,$(shell uname))" ""
  LDFLAGS  += -ldl -lm -L/home/fuzz/anaconda3/lib/python3.10/config-3.10-x86_64-linux-gnu -L/home/fuzz/anaconda3/lib -lm -lpython3.10
endif
